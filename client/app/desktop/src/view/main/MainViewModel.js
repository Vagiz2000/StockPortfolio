	  ...
	  data : [
		{
			"leaf": false,
			"children": [
			  { "text": "Stock", "iconCls": "x-fa fa-table", "xtype": "stockview", "leaf": true },
			  { "text": "Portfolio", "iconCls": "x-fa fa-table", "xtype": "portfolioview", "leaf": true },
			  { "text": "Strategy", "iconCls": "x-fa fa-table", "xtype": "strategyview", "leaf": true }
			]
		  }
	  ],
      /*proxy: {
