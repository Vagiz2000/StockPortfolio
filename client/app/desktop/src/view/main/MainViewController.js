Ext.define('StockPortfolio.view.main.MainViewController', {
  ...
  mainRoute:function(xtype) {
    ...
    if (node == null) {
      console.log('unmatchedRoute1: ' + xtype);
      return;
    }
  ...
  onHeaderViewNavToggle: function () {
    ...
    if (vm.get('navCollapsed') == true) {
      topPic.setData({ src:'resources/desktop/ois_logo.png', caption:'', imgStyle: 'imgSmall', height: '100px' });
    }
    else {
      topPic.setData({ src:'resources/desktop/ois_logo.png', caption:'', imgStyle: 'imgBig', height: '150px' });
    }
